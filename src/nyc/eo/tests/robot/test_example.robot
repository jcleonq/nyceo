...
#
#  $ bin/test -s nyc.eo -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src nyc.eo.testing.NYC_EO_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/nyc/eo/tests/robot/test_example.robot
#
